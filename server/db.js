...
export async function seedDatabase() {
  ...
  if (menuCount === 0) {
    const menuItems = [
      ...
      { name: 'Ruby Signature Cocktail', price: 550, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_red, description: 'Our luxurious, vibrant ruby-red house special, intricately garnished with delicate edible flower petals.' },
      { name: 'Smoked Rosemary Old Fashioned', price: 620, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_dark, description: 'A bold, amber-hued classic cocktail infused with the mesmerizing, aromatic smoke of a torched rosemary sprig.' },
      { name: 'Lychee Martini', price: 450, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_yellow, description: 'A crystal-clear, elegant martini radiating sweet lychee aromas, served in a sleek glass with a fresh lychee garnish.' },
      { name: 'Spicy Mango Margarita', price: 480, category: 'Drinks', isVegetarian: true, isSpicy: true, image: IMAGES.cocktail_yellow, description: 'A vibrant, tropical yellow margarita boasting sweet mango flavors, perfectly balanced by a fiery chili-salt rim.' },
      { name: 'Midnight Espresso Martini', price: 520, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_dark, description: 'A rich, dark, and velvety cocktail topped with a thick layer of creamy foam and three signature espresso beans.' },
      { name: 'Sunset Aperol Spritz', price: 420, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_red, description: 'A refreshing, sparkling cocktail glowing with the vibrant orange hues of a sunset, garnished with a fresh citrus slice.' },
      { name: 'Tokyo Sour', price: 580, category: 'Drinks', isVegetarian: true, isSpicy: false, image: IMAGES.cocktail_yellow, description: 'A sophisticated, pale-yellow cocktail crowned with a dense, frothy egg white foam, showcasing elegant Japanese mixology.' },
